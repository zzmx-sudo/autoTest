...
class DapingJiWang(PublicOperation):
    """大屏：鸡王"""
    def __init__(self, methodName='runTest', AllPirParams={}):
        super(DapingJiWang, self).__init__(methodName, AllPirParams)


    def dapingJiWangOK(self, driver, paramsIn, checkPoint):
        """用例说明：鸡王"""
#        caseName = sys._getframe().f_code.co_name  #获取本函数名
        ...
        self.dapingJiWangMapDispose(driver, paramsIn, checkPoint)


    def dapingJiWangMapDispose(self, driver, paramsIn, checkPoint):
        """移动到地图所有点击显示浮窗"""
        title = paramsIn['daPingTitleExpect']
